...
-- ─────────────────────────────────────────────────────────────
-- FRAGMENTO HORIZONTAL: Usuario (id_sucursal_registro = 2)
-- ─────────────────────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS Usuario (
  ...
  CONSTRAINT chk_usuario_sucursal CHECK (id_sucursal_registro = 2),
...
INSERT IGNORE INTO Usuario (id_usuario, nombre, apellidos, email, telefono, id_sucursal_registro, fecha_registro, multas_acumuladas) VALUES
  (2, 'Carlos', 'Ramírez López',  'cramirez@email.com', '664-111-0002', 2, '2023-03-22', 25.00),
  (8, 'Miguel', 'Reyes Espinoza', 'mreyes@email.com',   '664-111-0008', 2, '2023-10-18',  0.00);
